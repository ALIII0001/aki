...
const steps = [
  {
    ...
    description: "We go beyond clips. We find the moment that matters."
  },
  {
    number: "02",
    title: "Build the flow",
    description: "Timing, sound, silence - shaped to hold attention."
  },
  {
    number: "03",
    title: "Deliver for impact",
    description: "Every format optimized for where it lives."
  }
];
